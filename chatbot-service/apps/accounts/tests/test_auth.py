...
class UserModelTest(TestCase):
    ...
    def test_user_default_preferences(self) -> None:
        user = User.objects.create_user(email="test@example.com", password="pass123")
...
class SecurityLogModelTest(TestCase):
    ...
    def test_create_security_log(self) -> None:
    ...
    def test_anonymous_security_log(self) -> None:
        log = SecurityLog.objects.create(
            event="login_failed",
            method="password",
    ...
    def test_security_log_str(self) -> None:
        log = SecurityLog.objects.create(
...
class RegistrationViewTest(TestCase):
    ...
    def test_registration_creates_user_and_logs_in(self) -> None:
        data = {
    ...
    def test_registration_creates_security_log(self) -> None:
        data = {
