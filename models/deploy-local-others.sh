#!/bin/bash
# Start support model servers via Docker (text embed, mm embed, reranker, PaddleOCR).
...
{
  echo "# Local endpoints (auto-generated by deploy-local-others.sh)"
  echo "CHAT_BASE_URL=http://localhost:8430/v1"
  echo "CHAT_API_KEY=dummy"
  echo "CHAT_MODEL=google/gemma-4-26B-A4B-it"
  echo "VISION_MODEL=google/gemma-4-26B-A4B-it"
  echo ""
